#ScanFold_Convert_to_Genome_Coords.py
"""
By Warren B. Rouse, Moss Lab, Iowa State University

ScanFold transcript coordinates to genome coordinates
To run this script in the command line ensure script and bp file are in the working directory
...
Usage:python ScanFold_Convert_to_Genome_Coords.py ScanFold.bp StartCoord# Chr#  

This script will take three inputs, a .bp file from ScanFold, a starting genomic coordinate, and a chromosome number. This will convert transcript coordinates to genomic coordinates for easy comparison with annotation tracks
...
bpi = []					#Defining the column in the bp file that will be turned into bpi list
bpj = []					#Defining the column in the bp file that will be turned into bpj list
bpi2 = []					#Defining the column in the bp file that will be turned into genomic bpi list
bpj2 = []					#Defining the column in the bp file that will be turned into genomic bpj list
color = []					#Defining the column in the bp file that will be turned into color list
