...
#To run this script in the command line ensure script and bp file are in the working directory, call python, followed by script name, starting genomic coordinate, and chromosome written as 'Chr#'.
